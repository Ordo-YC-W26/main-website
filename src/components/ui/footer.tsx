...
import FooterImage from "../../assets/footer-sketch.svg";
            ...
            <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
              <div className="md:col-span-1">
                ...
                <div className="mt-6 flex items-center gap-4">
                  ...
                  <Link href="mailto:support@ordo.ai" aria-label="Email" className="text-neutral-600 hover:text-black dark:text-neutral-400 dark:hover:text-white">
                    <IconMail size={20} />
                  </Link>
                </div>
              </div>
