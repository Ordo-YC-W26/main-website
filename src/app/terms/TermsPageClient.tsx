      ...
      <main className="px-6 py-16 bg-white text-slate-900 dark:bg-black dark:text-white my-20 md:my-40 h-[10vh]">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mt-6 leading-8 text-neutral-700 dark:text-neutral-300">
            Our Terms of Service outline the rules and responsibilities for
            using ordo. They explain how our platform operates, how credits and
            listings work, what’s allowed in our marketplace, and how we protect
            the rights of all participants. By using ordo, you agree to these
            terms ensuring a safe, fair, and efficient environment for everyone.
          </p>
          <div className="mt-10">
            <Link
              href="/"
