      ...
      <main className="px-6 py-16 bg-white text-slate-900 dark:bg-black dark:text-white my-20 md:my-40 h-[10vh]">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mt-6 leading-8 text-neutral-700 dark:text-neutral-300">
            We believe the future of commerce is agentic where AI works for
            people, not the other way around. Traditional marketplaces are
            cluttered, slow, and inefficient, leaving users to do all the heavy
            lifting. ordo exists to change that. Our AI agents search, match,
            negotiate, and close deals seamlessly connecting individuals,
            sellers, and businesses in a frictionless ecosystem. We’re here to
            replace broken processes with intelligence, speed, and trust.
          </p>
          <div className="mt-10">
            <Link
              href="/"
