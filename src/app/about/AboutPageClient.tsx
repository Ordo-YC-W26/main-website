      ...
      <main className="px-6 py-16 bg-white text-slate-900 dark:bg-black dark:text-white my-20 md:my-40 h-[10vh]">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mt-6 leading-8 text-neutral-700 dark:text-neutral-300">
            ordo is the world’s first fully AI-handled marketplace and workflow
            engine. Whether you’re an individual looking for the perfect deal or
            a business aiming to streamline operations, our agents make it
            happen. From smart search to automated negotiations to deep
            analytics, ordo is built to handle the entire journey start to
            finish.
          </p>
          <p className="mt-4 leading-8 text-neutral-700 dark:text-neutral-300">
            We’re currently in private beta, working closely with early users
            and partners to refine our platform. If you’d like early access or
            want to explore business integrations, we’d love to hear from you.
          </p>
          <div className="mt-10">
            <Link
              href="/"
